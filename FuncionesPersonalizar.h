#ifndef FUNCIONESPERSONALIZAR_H_INCLUDED
#define FUNCIONESPERSONALIZAR_H_INCLUDED

//FUNCIONES EXTRAS PARA ALGUNAS FUNCIONES
enum Color{
cNEGRO=0,
cAZUL=1,
cVERDE=2,
...
#endif // FUNCIONESPERSONALIZAR_H_INCLUDED
